...
public class PriorityQueue
{
    ...
    public int Length => _queue.Count; // Automatically reflects the current count
...
public string Dequeue()
{
    ...
    {
        throw new InvalidOperationException("No items in the queue."); // Change the message here
    }
